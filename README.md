...
<body>
	...
	<div class="row">
		<div class="leftcolumn">
			<div class="card">
				<div class="fakeimg" style="height:726px;"><img src="img/pizza1.jpg" alt="pizza" height="700px" width="840px"></div>
		...
		<div class="rightcolumn">
			<div class="card">
				...
				<div class="fakeimg" style="height: 100px;">
					<img src="img/logopizza.png" alt="pizza" height="80px" width="200px">				</div> 
				<p>Somos una empresa 100% jarocha, creada por una universitaria</p> 
			</div> 
			<div class="card1">
				<div class="fakeimg">
					<a href="https://www.mercadolibre.com.mx/">
						<img src="img/mercadolibre.jpg" alt="mercadolibre" height="308px" width="250px">
					</a>
				</div>
			</div>
			<div class="card">
